...
function sumArray(sumArr) { //eslint-disable-line
    ...
    console.log('sum of  values = '+sum2[0]);
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    var product1 = multiply(testArray[0],testArray[1]);
    var product2 = multiply(product1[0],testArray[2]);
    console.log('multiply of  values = '+product2[0]);
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    return [
        result,
        'The numbers ' + dynamicArray + ' have a product of ' + result+ '.'
    ];
}
